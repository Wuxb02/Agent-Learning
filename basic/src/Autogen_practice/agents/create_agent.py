...
class AgentFactory:
    ...
    def __init__(self):
        self.model_client = HelloAgentsLLM().create_openai_model_client()
        self.agents = {
            ...
            "UserProxy": self._create_user_proxy()
                ...
                # 定义团队聊天和协作规则
        self.team_chat = RoundRobinGroupChat(
            participants=[
    ...
    def _create_engineer(self, model_client):
        """创建软件工程师智能体"""
    ...
    def _create_product_manager(self, model_client):
        """创建产品经理智能体"""
    ...
    def _create_code_reviewer(self, model_client):
        """创建代码审查员智能体"""
