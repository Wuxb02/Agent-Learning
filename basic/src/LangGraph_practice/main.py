...
def serpapi_search_node(state: SearchState) -> SearchState:
    """步骤2：使用 SerpApi 进行真实搜索"""
    ...
    try:
        ...
        if "answer_box_list" in results:
            ...
            search_results = results["answer_box"]["answer"]
        elif "knowledge_graph" in results and "description" in results["knowledge_graph"]:
            search_results = results["knowledge_graph"]["description"]
            ...
            search_results = f"抱歉，没有找到关于 '{search_query}' 的信息。"
